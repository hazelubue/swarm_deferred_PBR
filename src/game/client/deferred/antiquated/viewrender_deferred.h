...
public:
	...
	virtual const CViewSetup* GetPlayerViewSetup(int nSlot = -1) const { return BaseClass::GetPlayerViewSetup(); }
...
public:
	...
	void			ViewDrawSceneDeferred(const CViewSetup& view, int nClearFlags, view_id_t viewID, bool bDrawViewModel);
	...
	void			PerformMatrixView(const CViewSetup& view);
	...
	void			UpdateIndependentViewports();
