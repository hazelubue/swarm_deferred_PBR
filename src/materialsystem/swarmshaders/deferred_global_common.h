...
#define SHADOWMAPPING_DEPTH_COLOR__4X4_SOFTWARE_BILINEAR_PENUMBRA 7
...
#define FIRST_SHARED_LIGHTDATA_CONSTANT_GI 41
#define FIRST_SHARED_LIGHTDATA_CONSTANT_GI_FXC c41
