	...
	VertexCompressionType_t vertexCompression, CDeferredPerMaterialContextData* pDeferredContext)
{
		...
		DYNAMIC_STATE
	{
		...
		//SET_DYNAMIC_PIXEL_SHADER_COMBO(LIGHT_COUNT, numForwardLights);
		...
		//float rcpType = 1.0f / flLightType; // THIS CAUSES BUG FORCES SPOTLIGHT. WITHOUT USING IT WE ARE FORCED POINT LIGHT.
		//flLightType = rcpType;
