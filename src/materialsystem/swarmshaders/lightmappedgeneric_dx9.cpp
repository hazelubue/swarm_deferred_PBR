...
void SetupParmsGBuffer(defParms_gBuffer0& p)
{
	p.bModel = false;
	...
	p.FLOWMAP = 0;
	p.FLOWMAPFRAME = 0;
	p.FLOW_NOISE_TEXTURE = 0;

	p.FLOW_WORLDUVSCALE = 0;
	p.FLOW_NORMALUVSCALE = 0;
	p.FLOW_BUMPSTRENGTH = 0;
	p.COLOR_FLOW_DISPLACEBYNORMALSTRENGTH = 0;

	p.FLOW_TIMEINTERVALINSECONDS = 0;
	p.FLOW_UVSCROLLDISTANCE = 0;
	p.FLOW_NOISE_SCALE = 0;

	p.COLOR_FLOW_UVSCALE = 0;
	p.COLOR_FLOW_TIMEINTERVALINSECONDS = 0;
	p.COLOR_FLOW_UVSCROLLDISTANCE = 0;
	p.COLOR_FLOW_LERPEXP = 0;
