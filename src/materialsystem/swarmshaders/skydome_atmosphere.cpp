...
SHADER_PARAM(NOISE, SHADER_PARAM_TYPE_TEXTURE, "0.0", "")
SHADER_PARAM(WORLEY_BUBBLE_NOISE, SHADER_PARAM_TYPE_TEXTURE, "0.0", "")
SHADER_PARAM(WORLEY_NOISE, SHADER_PARAM_TYPE_TEXTURE, "0.0", "")
...
void SetupVars(Skydome_Vars_t& info)
{
	...
	info.m_nCloudNoise = NOISE;
	info.m_nWorleyBubbly = WORLEY_BUBBLE_NOISE;
	info.m_nWorleySwirley = WORLEY_NOISE;
}
